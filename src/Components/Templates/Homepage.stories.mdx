...
import { LibPath, Root } from 'Types';
...
export const componentName = 'Homepage';

<Meta   
    title={Root.Templates + componentName}
...
<DocsPageHeader
    ...
    componentDescription="This component shows how you can use the component pagecontainer and card component to make a homepage"
