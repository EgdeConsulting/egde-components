...
<DocsPageHeader
    ...
    componentDescription="This component is used to create an input which accepts text (numbers, letters and special characters) in a short and static textarea."
