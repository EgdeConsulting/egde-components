...
<DocsPageHeader
    title={componentName}
    description="This component is used to create a container which is supposed to stretch over a bigger area of the page. It can hold information like a title and text."
    ...
    <Story
        ...
        args={{
            ...
            titleBadge: {
                badgeColor: '#CC0000',
                textColor: '#FFFFFF',
                label: 'Read Important Information Below!!!',
            },
            children: (
                <div>
                    <p>
