...
import { AlertDialogProps, IconTestID, AlertDialogIconType } from 'egde-types';
import { Warning } from 'egde-icons';

export const AlertDialog = (props: AlertDialogProps): ReactElement => {
    const { iconVariant, heading, text, isOpen, cancelRef, onClose, buttons } =
        props;
