...
<DocsPageHeader
    componentName={componentName}
    componentDescription="This component is used to create an input which accepts text (numbers, 
...
will look and “feel” when its props are being configured in certain way. In order to define a certain set
